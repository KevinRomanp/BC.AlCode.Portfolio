table 51105 "Cobros Cajeros"
{
    ...
    fields
    {
        ...
        field(12; "No. Autorizacion"; Integer)
        {
            ...
            var
                ...
                NoAutorizacionErr: Label 'Este número de autorización ya existe.';
            begin
                DSNCobrosCajeros.Reset();
                DSNCobrosCajeros.SetRange("No. Autorizacion", rec."No. Autorizacion");
                if DSNCobrosCajeros.FindFirst() and ("No. Autorizacion" <> 0) then
                    Error(NoAutorizacionErr);
            end;*/
        }
        field(13; "No. Cheque"; Integer)
        {
            ...
            var
                DSNCobrosCajeros: Record "Cobros Cajeros";
                NoChequeErr: Label 'Este número de cheque ya existe.';
            begin
                DSNCobrosCajeros.Reset();
                DSNCobrosCajeros.SetRange("No. Cheque", rec."No. Cheque");
                if DSNCobrosCajeros.FindFirst() and ("No. Cheque" <> 0) then
                    Error(NoChequeErr);
            end;*/
        }
        ...
        /*field(23; "Monto devuelto"; decimal)
        {
            Caption = 'Monto devuelto';
            DataClassification = CustomerContent;
        }
        field(24; "Monto Documento"; integer)
        {
    ...
    //Leydi me dijo que se debe permitir que un cajero registre el documento de otro.
    trigger OnModify()
    begin
