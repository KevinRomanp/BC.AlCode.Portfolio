table 51103 ControlCajeros
{
    ...
    keys
    {
        ...
        /*FechaInicio es clave para que en el mismo dia no se pueda abrir la misma caja con el mismo usuario 2 veces
        ya que esto provocara que los calculos de importes de una linea se pasen a la otra.
        Si se crea el campo CodigoTurno en CobrosCajeros y se quita FechaInicio de clave, no dejara volver a crear otra 
        linea con el mismo usuario, caja y turno en el futuro.
        */
        key(BatchNo; BatchNo)
        { }
        //para poder organizar la pagina
