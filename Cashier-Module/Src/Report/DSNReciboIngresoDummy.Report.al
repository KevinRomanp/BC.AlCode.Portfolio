report 51103 "DSNRecibo Ingreso Dummy"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src\RDLC\FakeRecibo.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Recibo Ingreso Dummy';
    ...
    dataset
    {
        dataitem("G/L Register"; "G/L Register")
        {
            ...
            dataitem("G/L Entry"; "G/L Entry")
            {
                ...
                column(GLAcc_Name; GLAccountRecord.Name)
                {
                }
                ...
                begin
                    if not GLAccountRecord.Get("G/L Account No.") then
                        GLAccountRecord.Init();
    ...
    var
        GLAccountRecord: Record "G/L Account";
