    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                /*field("No. Autorizacion"; Rec."Req. No. Autorizacion")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Req. No. Autorizacion field.';
                    Caption = 'Req. No. Autorizacion';
                }
                field("No. Cheque"; Rec."Req. No. Cheque")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Req. No. Cheque field.';
